...
Func demosaic(Func input, int width, int height) {
    ...
    Func f0("demosaic_f0");             // G at B locations; G at R locations; 
    Func f1("demosaic_f1");             // B at green in B row, R column; R at green in R row, B column; 
    Func f2("demosaic_f2");             // B at green in R row, B column; R at green in B row, R column; 
    Func f3("demosaic_f3");             // B at red in R row, R column; R at blue in B row, B column; 
...
/*
    ...
    output(r1.x * 2 + 1, r1.y * 2 + 1, 2) = d3(r1.x * 2 + 1, r1.y * 2 + 1);     // B at blue in B row, B column
    ...
    output(r1.x * 2,     r1.y * 2,     0) = d3(r1.x * 2,     r1.y * 2);         // R at red in R row, R column
*/
